...
/*
 ...
 if let n = name {
 print("CF_EXPORT CFURLSessionEasyCode const CFURLSessionEasyCode\(n); // CURLE_\(n)")
 }
 }
 }
 */
...
/*
 ...
 if let n = name {
 print("CF_EXPORT CFURLSessionOption const CFURLSessionOption\(n); // CURLOPT_\(n)")
 }
 }
 }
 */
...
/*
 ...
 scanner.scanCharactersFromSet(valid, intoString: &name) {
 if let n = name {
 print("CF_EXPORT CFURLSessionInfo const CFURLSessionInfo\(n); // CURLINFO_\(n)")
 }
 }
 }
 */
...
/*
 ...
 scanner.scanUpToString(comma, intoString: &name) {
 if let n = name {
 print("CF_EXPORT CFURLSessionMultiOption const CFURLSessionMultiOption\(n); // CURLMOPT_\(n)")
 }
 }
 }
 */
...
/*
 ...
 scanner.scanCharactersFromSet(valid, intoString: &name) {
 if let n = name {
 print("CF_EXPORT CFURLSessionMultiCode const CFURLSessionMultiCode\(n); // CURLM_\(n)")
 }
 }
 }
 */
...
/*
 ...
 scanner.scanCharactersFromSet(valid, intoString: &name) {
 if let n = name {
 print("CF_EXPORT CFURLSessionProtocol const CFURLSessionProtocol\(n); // CURLPROTO_\(n)")
 }
 }
 }
 */
